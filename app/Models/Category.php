...
{
    protected $fillable = ['name', 'homepage_display_name' , 'description','parent_id','banner_image','breadcrumb_title','category_icon','seo_title','seo_description','is_home','is_popular', 'show_in_search','credit_score_model','status'];
