<x-app-layout>
    <x-slot name="header">@if($settings) {{ __('Update Settings') }} @else {{ __('Add Settings') }} @endif  </x-slot>
        ...
        @endif
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <input type="text" id="setting_name" class="form-control" name="setting_name" class="form-control{{ $errors->has('setting_name') ? ' is-invalid' : '' }}" value="{{ $settings ? $settings->setting_name : old('setting_name') }}" required placeholder="Setting Name">
            ...
            <div class="col-md-6">
              ...
              <input type="text" id="setting_value" class="form-control" name="setting_value" class="form-control{{ $errors->has('setting_value') ? ' is-invalid' : '' }}" value="{{ $settings ? $settings->setting_value : old('setting_value') }}" required placeholder="Setting Value">
