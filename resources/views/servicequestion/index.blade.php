...
@section('title', 'Service Questions')
  ...
  <div class="d-flex justify-content-between align-items-center mb-3 mt-3">
    <h4 class="mb-0">{{ __("Service Questions") }}</h4>
    @can('servicequestions.create')
    <a href="{{ route('servicequestion.create') }}" class="btn btn-success text-white">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <span class="fw-bold">Credit Score Model:</span> {{$aRow->categories->credit_score_model ?? '' }}
            </td>
