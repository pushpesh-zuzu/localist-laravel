      ...
      <div class="card-body">
        ...
        <table class="table table-striped" id="dataTable">
          ...
          <tr>
            ...
            <td>
                <a href="{{ route('buyer.show', ['type' => 'abandoned', 'id' => $aRow->id]) }}" data-coreui-toggle="tooltip" data-coreui-placement="top" data-coreui-original-title="View"> <i class="bi bi-eye"></i></a>
