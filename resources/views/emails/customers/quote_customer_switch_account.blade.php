...
<body style="margin:0; padding:0; background:#f1f2f4; -webkit-font-smoothing:antialiased;">
  <table role="presentation" width="100%" class="email-wrap" style="width:100%; background:#f1f2f4; padding:24px 0;">
    <tr>
      <td align="center">
        <table role="presentation" class="email-container" width="600" cellpadding="0" cellspacing="0" style="width:100%; max-width:600px; margin:0 auto;">

          <!-- Logo -->
          <tr>
            <td align="center" style="padding:0 16px 20px 16px;">
              <img src="{{ $baseUrl }}/assets/localist_logo_1.png" alt="Localists" class="logo" width="180" style="max-height:48px; display:block; margin:0 auto; max-width:100%; height:auto;">
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 16px;">
              <table role="presentation" width="100%" class="card" style="background:#ffffff; border-radius:6px; box-shadow:0 1px 3px rgba(0,0,0,.06); overflow:hidden;">

                <!-- Greeting inside card -->
                <tr>
                  <td style="padding:20px;">
                    <h1>Hi Test seller</h1>
                    <div class="lead-sub">
                      You’ve successfully switched from your Quote Customer account to your Lead Buyer account.
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="background:#00afe3; padding:12px 16px; color:#fff; font-weight:700; font-size:15px;">
                    <table role="presentation" width="100%">
                      <tr>
                        <td>As a Lead Buyer, you can now:</td>
                        <td style="width:36px; text-align:right;">
                          <img src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/c5dSX3CKrL/91cawf2y_expires_30_days.png" width="24" alt="">
                        </td>
                      </tr>
                    </table>
                  </td>
                    ...
                    <table role="presentation" width="100%">
                      <tr>
                        <td style="padding-bottom:12px;">
                          <table role="presentation">
                            <tr>
                              <td style="padding-right:10px;"><img src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/c5dSX3CKrL/oj1l38rt_expires_30_days.png" width="28" alt=""></td>
                              <td style="font-size:14px; font-weight:600; color:#000;">Finalize purchases</td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-bottom:12px;">
                          <table role="presentation">
                            <tr>
                              <td style="padding-right:10px;"><img src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/c5dSX3CKrL/9eq11d29_expires_30_days.png" width="28" alt=""></td>
                              <td style="font-size:14px; font-weight:600; color:#000;">Manage customer relationships</td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <table role="presentation">
                            <tr>
                              <td style="padding-right:10px;"><img src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/c5dSX3CKrL/jt0r19d0_expires_30_days.png" width="28" alt=""></td>
                              <td style="font-size:14px; font-weight:600; color:#000;">Review quotes and generate orders</td>
                            </tr>
                          </table>
                        </td>
                      </tr>
