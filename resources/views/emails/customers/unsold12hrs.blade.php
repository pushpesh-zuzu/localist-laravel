                            ...
                            <tr>
                              ...
                              <td class="stack" align="center" valign="top" style="padding:8px;">
                                ...
                                <table role="presentation" cellpadding="0" cellspacing="0" border="0" bgcolor="#00AFE3" style="border-radius:7px;margin-top:8px;">
                                  <tr>
                                    <td style="padding:13px 12px;text-align:center;"><span style="color:#fff;font-size:14px;font-weight:700;">Trusted by customers</span></td>
                                  </tr>
                                </table>
                              </td>
                              <!-- Chip 2 -->
                              <td class="stack" align="center" valign="top" style="padding:8px;">
                                ...
                                <table role="presentation" cellpadding="0" cellspacing="0" border="0" bgcolor="#00AFE3" style="border-radius:7px;margin-top:8px;">
                                  <tr>
                                    <td style="padding:13px 12px;text-align:center;"><span style="color:#fff;font-size:14px;font-weight:700;">Quick to respond</span></td>
                                  </tr>
                                </table>
                              </td>
                              <!-- Chip 3 -->
                              <td class="stack" align="center" valign="top" style="padding:8px;">
                                ...
                                <table role="presentation" cellpadding="0" cellspacing="0" border="0" bgcolor="#00AFE3" style="border-radius:7px;margin-top:8px;">
                                  <tr>
                                    <td style="padding:13px 12px;text-align:center;"><span style="color:#fff;font-size:14px;font-weight:700;">Highly rated for quality and reliability</span></td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
                ...
                <tr>
                  <td style="padding:23px 24px 6px 24px;">
                    <table role="presentation" align="center" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #00AFE3;border-radius:2px;">
                      <tr>
                        <td style="padding:6px 22px;"><span style="color:#00AFE3;font-weight:700;font-size:18px;line-height:22px;">Here are a few you might like:</span></td>
                      </tr>
                    </table>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:10px 16px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#d8edf8" style="border-radius:6px;">
                ...
                <tr>
            <td align="center" style="padding:10px 16px;background:#f4f6f8;">
