          ...
          <tr>
            <td style="padding:5px 30px;">
              ...
              <p style="color:#253238;font-size:14px;line-height: 30px;">
                You've purchased a <strong>{{ $service }}</strong> lead. Please update its status below:
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:20px;">
                <tr>
                  <td>
                    <!-- Buttons Container -->
                    <table width="100%" cellpadding="0" cellspacing="0"
                      style="background:#ffffff; padding:14px; border-radius:0 0 4px 4px;">
                      <tr>
                        <td>
                          <!-- Button 1 -->
                          <a href="{{ url('/api/lead-purchase-status-update-log/' . $lead_id . '/' . $seller_id . '/' . $buyer_id . '/Attempted Contact (no response)') }}" style="display:block; background:#E3F6FC; color:#00AFE3;
                                      text-decoration:none; font-size:14px; font-weight:600;
                                      padding:12px 14px; border-radius:6px; margin-bottom:10px;
                                      border:1px solid #00AFE3;">
                            <img src="{{$siteUrl}}/public/images/icons/phone-black.png" width="16" height="16"
                              style="vertical-align:middle; margin-right:6px;">
                            Attempted Contact (no response)
                          </a>

                          <!-- Button 2 -->
                          <a href="{{ url('/api/lead-purchase-status-update-log/' . $lead_id . '/' . $seller_id . '/' . $buyer_id . '/Contact made with the Buyer (in process of providing  quotes)') }}" style="display:block; background:#E3F6FC; color:#00AFE3; text-decoration:none; font-size:14px; font-weight:600;
                            padding:12px 14px; border-radius:6px; margin-bottom:10px;
                            border:1px solid #00AFE3;">
                            <img src="{{$siteUrl}}/public/images/icons/file-check-black.png" width="16" height="16"
                              style="vertical-align:middle; margin-right:6px;">
                            Contact made (in process of providing quotes)
                          </a>


                          <a href="{{ url('/api/lead-purchase-status-update-log/' . $lead_id . '/' . $seller_id . '/' . $buyer_id . '/Contact made with the Buyer (Quote Provided)') }}" style="display:block; background:#E3F6FC; color:#00AFE3; text-decoration:none; font-size:14px; font-weight:600;
                            padding:12px 14px; border-radius:6px; margin-bottom:10px;
                            border:1px solid #00AFE3;">
                            <img src="{{$siteUrl}}/public/images/icons/file-check-black.png" width="16" height="16"
                              style="vertical-align:middle; margin-right:6px;">
                          ...
                          <!-- Button 4 -->
                          <a href="{{ url('/api/lead-purchase-status-update-log/' . $lead_id . '/' . $seller_id . '/' . $buyer_id . '/Contact made with Buyer & Quote Provided (no hire)') }}" style="display:block; background:#E3F6FC; color:#00AFE3;
                            text-decoration:none; font-size:14px; font-weight:600;
                            padding:12px 14px; border-radius:6px; margin-bottom:10px;
                            border:1px solid #00AFE3;">
                            <img src="{{$siteUrl}}/public/images/icons/alert-triangle-black.png" width="16" height="16"
                              style="vertical-align:middle; margin-right:6px;">
                            Contact made & Quote Provided (no hire)
                          </a>

                          <!-- Button 5 -->
                          <a href="{{ url('/api/lead-purchase-status-update-log/' . $lead_id . '/' . $seller_id . '/' . $buyer_id . '/Contact made with Buyer & Quote Provided (hired)') }}" style="display:block; background:#E3F6FC; color:#00AFE3;
                              text-decoration:none; font-size:14px; font-weight:600;
                              padding:12px 14px; border-radius:6px;
                              border:1px solid #00AFE3;">
                            <img src="{{$siteUrl}}/public/images/icons/user-check-black.png" width="16" height="16"
                              style="vertical-align:middle; margin-right:6px;">
