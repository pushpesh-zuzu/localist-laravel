        ...
        <table role="presentation" class="email-container" width="600" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="center" style="padding:0 16px 20px 16px;">
              <img src="{{ $baseUrl }}/assets/localist_logo.png" alt="Localists" class="logo" width="180" style="max-width:100%; height:auto;">
            </td>
          </tr>
              ...
              <table role="presentation" width="100%" class="card" style="background:#111637; color:#fff;">
                <tr>
                  ...
                  <td style="padding:12px 14px; text-align:right;">
                    <img src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/c5dSX3CKrL/bi4t4478_expires_30_days.png" width="24" alt="">
                  </td>
                </tr>
                <tr>
