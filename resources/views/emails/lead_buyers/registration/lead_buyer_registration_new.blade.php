      ...
      <tr>
        <td style="padding:0;">
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:20px;">
            <!-- Feature 1 -->
            <tr>
              <td style="background-color:#e3f6fc; border-radius:10px; padding:14px; margin-bottom:20px;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tr>
                ...
                <p style="margin-top:10px; color:#252832; font-size:12px; font-weight:500; line-height:18px;">At Localists.com, we handle all the marketing work on your behalf. Our team sets budgets specifically for your service types in your location, ensuring you get targeted exposure and high-quality leads without lifting a finger. This means you can focus on winning jobs while we take care of generating the opportunities. You then choose only the jobs you want. Once you purchase your first credit pack, you will receive an email from our marketing the lead types and locations you are most interested in seeing a higher volume of leads for. Within 72 hours of your confirmation this will be implemented by the marketing team and you will see a steady stream of leads coming in tailored to your exact needs.</p>
              </td>
            </tr>
            <!-- Feature 2 -->
            <tr>
            ...
            <tr>
              <td style="background-color:#e3f6fc; border-radius:10px; padding:14px; margin-bottom:20px;">
                ...
                <p style="margin-top:10px; color:#252832; font-size:12px; font-weight:500; line-height:18px;">We make life easier by connecting you with high‑intent customers who choose your company directly while live on our platform. Keep your profile up to date and respond quickly to calls, messages or emails to turn every request into a win.</p>
              </td>
            </tr>
            <!-- Feature 4 -->
            <tr>
              <td style="background-color:#edfcf8; border-radius:10px; padding:14px; margin-bottom:20px;">
                ...
                <p style="margin-top:5px; color:#252832; font-size:12px; font-weight:500; line-height:18px;">To give you plenty of time to utilise the platform, your credits are valid for 12 months, giving you more time to experience our high quality, high intent leads without any pressure. Add some credit to your account now.</p>
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:20px; display:flex; width:100%;">
            <tr>
              <td style="background-color:#00afe3; border-radius:12px 0 0 12px; padding:20px; width:50%; vertical-align:top;">
                <p style="color:#fff; font-size:12px; font-weight:700; line-height:14px;">We’d also love to know if you’re interested in EXCLUSIVE LEADS a powerful way to secure more jobs with minimal competition. Please speak to your account manager to find out more information regarding our <span style="color:#253238;">exclusive leads.</span></p>
                <a href="{{$baseUrl}}/en/gb/contact-us" style="display:inline-block; padding:8px 15px; background-color:#252832; color:#fff; font-weight:700; text-decoration:none; border-radius:26px; margin-top:10px;">Contact Us</a>
              </td>
              <td style="width:50%; text-align:right;">
                <img src="{{$siteUrl}}/public/images/contactus.png" alt="Contact Us" style="width:100%; max-width:192px; border-radius:0 12px 12px 0; object-fit:cover;">
              </td>
            </tr>
          </table>
